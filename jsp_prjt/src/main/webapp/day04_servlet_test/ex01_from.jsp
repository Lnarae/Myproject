...
<body>
	...
	성별:<input type = "radio" name = "gender" value = "W" checked>여
	메일정보 수신여부:<input type = "radio" name = "receive_email" value = "Y" checked>수신
	...
	<input type = "submit" name = "submit_btn" value = "get방식으로 전송">
	</from>
</body>
</html>