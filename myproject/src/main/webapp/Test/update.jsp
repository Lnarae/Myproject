...
<head>
    ...
    <title>개인 프로젝트 회원정보 수정 페이지</title>
...
<body>
    <div class="wrap">
        <div class="container">
            <form action="join_process.jsp" id="frm_Join" name="frm_Join" method="post">
            <input type="hidden" name="m_idx" value="<%=dto.getM_idx() %>">
                <div class="join_box">
                    <p>이름</p>
                        <div><input type="text" name="name" id="name" value="<%=dto.getMember_name() %>"></div>
                    ...
                    <div id="handphone_box">
                        <p>휴대전화</p>
                        <input type="tel" name="phone" id="phone" placeholder="휴대폰번호입력" value="<%=dto.getHandphone()%>">
                    </div>
                    <div id="join_id">
                        <p>아이디</p>
                        <input type="text" name="id" id="member_id" value="<%=dto.getMember_id()%>">
                        <input type="button" name="id_btn" id="join_btn" value="유효성검사">
                    </div>
                    <div id="join_pw">
                        <p>비밀번호</p>
                        <input type="password" name="pw" id="member_pw value="<%=dto.getMember_pw()%>">
