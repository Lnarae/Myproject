...
import human.utll.DBConnection;
	...
	public ArrayList<BoardDTO> getBoards(){
		...
		try {
			...
			while(rs.next()) {
				...
				dto.setOriginfile_name(rs.getString("orginfile_name"));
	...
	public int update(BoardDTO dto) {
		...
		try {
			if(dto.getOriginfile_name() != null) {
				...
				String sql = "update tb_board set title=?, content=?, originfilename=?, savefilename=? "
						     + " where b_idx=?";
